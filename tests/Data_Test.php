...
if (!is_null($expr) && !is_string($value)) { throw new \InvalidArgumentException('Field A1 has type string'); }
return $value;
}
...
if (!is_null($expr) && !is_string($value)) { throw new \InvalidArgumentException('Field A4 has type string'); }
return $value;
}
public function get_A5() { return $this->A5; }
protected function validate_A5($value) {
if (!is_null($expr) && !is_string($value)) { throw new \InvalidArgumentException('Field A5 has type string'); }
return $value;
}
...
if (!is_null($expr) && !is_string($value)) { throw new \InvalidArgumentException('Field B1 has type string'); }
return $value;
}
...
if (!is_null($expr) && !is_string($value)) { throw new \InvalidArgumentException('Field B4 has type string'); }
return $value;
}
...
if (!is_null($expr) && !is_string($value)) { throw new \InvalidArgumentException('Field B5 has type string'); }
return $value;
}
...
if (!is_null($expr) && !is_string($value)) { throw new \InvalidArgumentException('Field C1 has type string'); }
return $value;
}
...
if (!is_null($expr) && !is_string($value)) { throw new \InvalidArgumentException('Field C4 has type string'); }
return $value;
}
public function get_C5() { return $this->C5; }
protected function validate_C5($value) {
if (!is_null($expr) && !is_string($value)) { throw new \InvalidArgumentException('Field C5 has type string'); }
return $value;
}
...
if (!is_null($expr) && !is_string($value)) { throw new \InvalidArgumentException('Field D1 has type string'); }
return $value;
}
...
if (!is_null($expr) && !is_string($value)) { throw new \InvalidArgumentException('Field D4 has type string'); }
return $value;
}
...
if (!is_null($expr) && !is_string($value)) { throw new \InvalidArgumentException('Field D5 has type string'); }
return $value;
}
